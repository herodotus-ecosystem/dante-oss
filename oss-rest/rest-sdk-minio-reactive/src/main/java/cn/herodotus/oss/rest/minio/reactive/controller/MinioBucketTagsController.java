...
import cn.herodotus.oss.core.minio.request.bucket.DeleteBucketTagsRequest;
import cn.herodotus.oss.core.minio.request.bucket.SetBucketTagsRequest;
...
public class MinioBucketTagsController implements OssController {
    ...
    @PutMapping
    public Mono<Result<VoidResponse>> set(@Validated @RequestBody SetBucketTagsRequest request) {
        Mono<Void> result = minioBucketTagsService.setBucketTags(request.build());
    ...
    @DeleteMapping
    public Mono<Result<VoidResponse>> delete(@Validated @RequestBody DeleteBucketTagsRequest request) {
        Mono<Void> result = minioBucketTagsService.deleteBucketTags(request.build());
        return fromVoid(result);
    }
}
