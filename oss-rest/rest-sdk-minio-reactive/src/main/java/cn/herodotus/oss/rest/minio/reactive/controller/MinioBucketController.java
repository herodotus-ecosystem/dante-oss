...
import cn.herodotus.oss.rest.minio.reactive.request.bucket.RemoveBucketRequest;
import cn.herodotus.oss.rest.minio.reactive.response.VoidResponse;
import cn.herodotus.oss.rest.minio.reactive.request.bucket.BucketExistsRequest;
import cn.herodotus.oss.rest.minio.reactive.request.bucket.ListBucketsRequest;
import cn.herodotus.oss.rest.minio.reactive.request.bucket.MakeBucketRequest;
...
public class MinioBucketController implements OssController {
    ...
    @GetMapping("/list")
    public Mono<Result<List<BucketDomain>>> listBuckets(ListBucketsRequest request) {
        Mono<List<BucketDomain>> buckets = minioBucketService.listBuckets(request.build());
        return fromList(buckets);
    }
    ...
    @GetMapping("/exists")
    public Mono<Result<Boolean>> doesBucketExist(BucketExistsRequest request) {
        Mono<Boolean> isExists = minioBucketService.bucketExists(request.build());
    ...
    @PostMapping
    public Mono<Result<VoidResponse>> createBucket(@Validated @RequestBody MakeBucketRequest request) {
        Mono<Void> result = minioBucketService.makeBucket(request.build());
    ...
    @DeleteMapping
    public Mono<Result<VoidResponse>> deleteBucket(@Validated @RequestBody RemoveBucketRequest request) {
        Mono<Void> result = minioBucketService.removeBucket(request.build());
        return fromVoid(result);
    }
}
