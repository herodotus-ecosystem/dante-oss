...
import cn.herodotus.oss.rest.minio.reactive.service.MinioBucketSettingService;
...
public class MinioBucketSettingController implements OssController {

    private final MinioBucketSettingService minioBucketSettingService;

    public MinioBucketSettingController(MinioBucketSettingService minioBucketSettingService) {
        this.minioBucketSettingService = minioBucketSettingService;
    }
    ...
    @GetMapping
    public Mono<Result<BucketSettingBusiness>> get(@RequestParam(value = "bucketName") String bucketName) {
        Mono<BucketSettingBusiness> entity = minioBucketSettingService.get(bucketName);
