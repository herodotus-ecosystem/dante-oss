...
public class MinioBucketVersioningController implements OssController {
    ...
    @PutMapping
    public Mono<Result<VoidResponse>> set(@Validated @RequestBody SetBucketVersioningRequest request) {
        Mono<Void> result = minioBucketVersioningService.setBucketVersioning(request.build());
