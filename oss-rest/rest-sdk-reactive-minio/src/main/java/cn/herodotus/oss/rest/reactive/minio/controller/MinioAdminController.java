...
import cn.herodotus.oss.dialect.reactive.minio.service.MinioAdminService;
...
public class MinioAdminController implements OssController {
    ...
    @GetMapping("/usage")
    public Mono<Result<DataUsageInfo>> dataUsageInfo() {
        Mono<DataUsageInfo> info = minioAdminService.getDataUsageInfo();
        return result(info);
    }
}
