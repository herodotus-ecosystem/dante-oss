...
public class MinioBucketQuotaController implements OssController {
    ...
    @PutMapping
    public Mono<Result<VoidResponse>> set(@Validated @RequestBody SetBucketQuotaRequest request) {
        Mono<Void> result = minioBucketQuotaService.setBucketQuota(request.getBucketName(), request.getSize(), QuotaUnit.valueOf(request.getUnit().name()));
