...
public class MinioBucketEncryptionController implements OssController {
    ...
    @PutMapping
    public Mono<Result<VoidResponse>> set(@Validated @RequestBody SetBucketEncryptionRequest request) {
        Mono<Void> result = minioBucketEncryptionService.setBucketEncryption(request.build());
    ...
    @DeleteMapping
    public Mono<Result<VoidResponse>> delete(@Validated @RequestBody DeleteBucketEncryptionRequest request) {
        Mono<Void> result = minioBucketEncryptionService.deleteBucketEncryption(request.build());
        return fromVoid(result);
    }
}
