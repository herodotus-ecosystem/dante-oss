...
import cn.herodotus.oss.core.minio.request.bucket.DeleteBucketPolicyRequest;
import cn.herodotus.oss.core.minio.request.bucket.SetBucketPolicyRequest;
...
public class MinioBucketPolicyController implements OssController {
    ...
    @PutMapping
    public Mono<Result<VoidResponse>> set(@Validated @RequestBody SetBucketPolicyRequest request) {
        Mono<Void> result = minioBucketPolicyService.setBucketPolicy(request.build());
    ...
    @DeleteMapping
    public Mono<Result<VoidResponse>> delete(@Validated @RequestBody DeleteBucketPolicyRequest request) {
        Mono<Void> result = minioBucketPolicyService.deleteBucketPolicy(request.build());
        return fromVoid(result);
    }
}
