...
public class MinioObjectLockConfigurationController implements OssController {
    ...
    @PutMapping
    public Mono<Result<VoidResponse>> set(@Validated @RequestBody SetObjectLockConfigurationRequest request) {
        Mono<Void> result = minioObjectLockConfigurationService.setObjectLockConfiguration(request.build());
    ...
    @DeleteMapping
    public Mono<Result<VoidResponse>> delete(@Validated @RequestBody DeleteObjectLockConfigurationRequest request) {
        Mono<Void> result = minioObjectLockConfigurationService.deleteObjectLockConfiguration(request.build());
        return fromVoid(result);
    }
}
