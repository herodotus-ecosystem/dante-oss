...
import cn.herodotus.oss.rest.reactive.minio.service.MinioObjectSettingService;
...
public class MinioObjectSettingController implements OssController {

    private final MinioObjectSettingService minioObjectSettingService;

    public MinioObjectSettingController(MinioObjectSettingService minioObjectSettingService) {
        this.minioObjectSettingService = minioObjectSettingService;
    }
    ...
    @GetMapping
    public Mono<Result<ObjectSettingBusiness>> get(@RequestParam(value = "bucketName") String bucketName, @RequestParam(value = "objectName") String objectName) {
        Mono<ObjectSettingBusiness> entity = minioObjectSettingService.get(bucketName, null, objectName);
