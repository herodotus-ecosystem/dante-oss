...
import cn.herodotus.oss.core.minio.request.object.DisableObjectLegalHoldRequest;
import cn.herodotus.oss.core.minio.request.object.EnableObjectLegalHoldRequest;
import cn.herodotus.oss.dialect.reactive.minio.service.MinioObjectLegalHoldService;
...
public class MinioObjectLegalHoldController implements OssController {
    ...
    @PutMapping("/enable")
    public Mono<Result<VoidResponse>> enable(@Validated @RequestBody EnableObjectLegalHoldRequest request) {
        Mono<Void> result = minioObjectLegalHoldService.enableObjectLegalHold(request.build());
    ...
    @PutMapping("/disable")
    public Mono<Result<VoidResponse>> disable(@Validated @RequestBody DisableObjectLegalHoldRequest request) {
        Mono<Void> result = minioObjectLegalHoldService.disableObjectLegalHold(request.build());
        return fromVoid(result);
    }
}
