...
<p align="center">
    ...
    <a href="#" target="_blank"><img src="https://shields.io/badge/Version-1.3.2-red.svg?logo=spring" alt="Version 1.3.2"></a>
...
| 2  | Spring Boot 3 之自动配置与注入顺序控制    | 付费 | Spring 生态重要知识点，掌握步入微服务的关键开关                                               | ![Spring Boot 3 之自动配置与注入顺序控制](./readme/cookbook/0003.png)    |
