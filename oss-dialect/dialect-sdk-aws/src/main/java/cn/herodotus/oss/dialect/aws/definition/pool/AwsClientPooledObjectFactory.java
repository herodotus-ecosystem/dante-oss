...
import cn.herodotus.oss.dialect.aws.properties.AwsProperties;
 ...
 */
public class AwsClientPooledObjectFactory extends AbstractOssClientPooledObjectFactory<S3AsyncClient> {

    private final AwsProperties awsProperties;

    public AwsClientPooledObjectFactory(AwsProperties awsProperties) {
        super(awsProperties);
