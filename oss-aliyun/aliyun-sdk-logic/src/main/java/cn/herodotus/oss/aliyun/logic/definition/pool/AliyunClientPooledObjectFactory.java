 ...
 */
public class AliyunClientPooledObjectFactory extends BasePooledObjectFactory<OSSClient> {
    ...
    @Override
    public PooledObject<OSSClient> wrap(OSSClient ossClient) {
        return new DefaultPooledObject<>(ossClient);
    }

    @Override
    public void destroyObject(PooledObject<OSSClient> p) throws Exception {
        OSSClient client = p.getObject();
