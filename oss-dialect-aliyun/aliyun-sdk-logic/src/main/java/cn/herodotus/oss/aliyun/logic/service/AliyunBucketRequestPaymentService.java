 ...
 */
public class AliyunBucketRequestPaymentService extends BaseAliyunClientService {
    ...
    public VoidResult setBucketRequestPayment(SetBucketRequestPaymentRequest request) {
        ...
        try {
            return ossClient.setBucketRequestPayment(request);
    ...
    public GetBucketRequestPaymentResult getBucketRequestPayment(GenericRequest request) {
        ...
        try {
            return ossClient.getBucketRequestPayment(request);
        } catch (ClientException e) {
            log.error("[Herodotus] |- Aliyun OSS catch ClientException in [{}].", function, e);
            throw new OssServerException(e.getMessage());
        } catch (OSSException e) {
