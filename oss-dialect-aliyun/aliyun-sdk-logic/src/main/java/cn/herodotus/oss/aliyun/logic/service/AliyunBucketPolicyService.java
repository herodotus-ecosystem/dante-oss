 ...
 * @date : 2023/7/23 18:37
 */
public class AliyunBucketPolicyService extends BaseAliyunClientService {
    ...
    public VoidResult setBucketPolicy(SetBucketPolicyRequest request) {
        ...
        try {
            return ossClient.setBucketPolicy(request);
    ...
    public GetBucketPolicyResult getBucketPolicy(GenericRequest request) {
        ...
        try {
            return ossClient.getBucketPolicy(request);
        } catch (ClientException e) {
            log.error("[Herodotus] |- Aliyun OSS catch ClientException in [{}].", function, e);
            throw new OssServerException(e.getMessage());
        } catch (OSSException e) {
    ...
    public VoidResult deleteBucketPolicy(GenericRequest request) {
        ...
        try {
            return ossClient.deleteBucketPolicy(request);
        } catch (ClientException e) {
            log.error("[Herodotus] |- Aliyun OSS catch ClientException in [{}].", function, e);
            throw new OssServerException(e.getMessage());
        } catch (OSSException e) {
