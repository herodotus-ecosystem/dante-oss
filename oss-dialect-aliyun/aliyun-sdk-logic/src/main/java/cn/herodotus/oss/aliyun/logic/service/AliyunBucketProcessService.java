 ...
 */
public class AliyunBucketProcessService extends BaseAliyunClientService {

    private static final Logger log = LoggerFactory.getLogger(AliyunBucketProcessService.class);

    public AliyunBucketProcessService(AbstractOssClientObjectPool<OSS> ossClientObjectPool) {
    ...
    public VoidResult setBucketProcess(SetBucketProcessRequest request) {
        ...
        try {
            return ossClient.setBucketProcess(request);
    ...
    public BucketProcess getBucketProcess(GenericRequest request) {
        ...
        try {
            return ossClient.getBucketProcess(request);
        } catch (ClientException e) {
            log.error("[Herodotus] |- Aliyun OSS catch ClientException in [{}].", function, e);
            throw new OssServerException(e.getMessage());
        } catch (OSSException e) {
