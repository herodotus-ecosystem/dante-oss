 ...
 */
public class AliyunVodPlaylistService extends BaseAliyunClientService {

    private static final Logger log = LoggerFactory.getLogger(AliyunVodPlaylistService.class);

    public AliyunVodPlaylistService(AbstractOssClientObjectPool<OSS> ossClientObjectPool) {
    ...
    public VoidResult generateVodPlaylist(GenerateVodPlaylistRequest request) {
        ...
        try {
            return ossClient.generateVodPlaylist(request);
    ...
    public OSSObject getVodPlaylist(GetVodPlaylistRequest request) {
        ...
        try {
            return ossClient.getVodPlaylist(request);
        } catch (ClientException e) {
            log.error("[Herodotus] |- Aliyun OSS catch ClientException in [{}].", function, e);
            throw new OssServerException(e.getMessage());
        } catch (OSSException e) {
