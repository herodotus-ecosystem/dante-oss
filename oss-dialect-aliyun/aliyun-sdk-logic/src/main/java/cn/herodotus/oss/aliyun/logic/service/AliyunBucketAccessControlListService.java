 ...
 */
@Service
public class AliyunBucketAccessControlListService extends BaseAliyunClientService {
    ...
    public VoidResult setBucketAcl(SetBucketAclRequest request) {
        ...
        try {
            return ossClient.setBucketAcl(request);
    ...
    public AccessControlList getBucketAcl(GenericRequest request) {
        ...
        try {
            return ossClient.getBucketAcl(request);
        } catch (ClientException e) {
            log.error("[Herodotus] |- Aliyun OSS catch ClientException in [{}].", function, e);
            throw new OssServerException(e.getMessage());
        } catch (OSSException e) {
