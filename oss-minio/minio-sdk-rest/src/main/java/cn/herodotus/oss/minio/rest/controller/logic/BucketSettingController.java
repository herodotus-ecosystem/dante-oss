...
import cn.herodotus.oss.minio.logic.service.BucketSettingService;
...
public class BucketSettingController implements Controller {

    private final BucketSettingService settingService;

    public BucketSettingController(BucketSettingService settingService) {
