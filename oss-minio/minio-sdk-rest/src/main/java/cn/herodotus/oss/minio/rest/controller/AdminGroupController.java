...
import cn.herodotus.oss.minio.core.converter.GroupInfoToDomainConverter;
import cn.herodotus.oss.minio.core.domain.GroupDomain;
import cn.herodotus.oss.minio.core.domain.UserDomain;
import cn.herodotus.oss.minio.logic.service.AdminGroupService;
...
public class AdminGroupController implements Controller {
    ...
    public Result<List<String>> list() {
        List<String> groups = adminGroupService.listGroups();
    ...
    public Result<GroupDomain> get(String group) {
        GroupInfo groupInfo = adminGroupService.getGroupInfo(group);
    ...
    public Result<Boolean> add(@Validated @RequestBody GroupDomain domain) {
        adminGroupService.addUpdateGroup(domain.getName(), domain.getStatus(), domain.getMembers());
        return result(true);
    }
    ...
    public Result<Boolean> remove(String group) {
        adminGroupService.removeGroup(group);
        return result(true);
    }
}
