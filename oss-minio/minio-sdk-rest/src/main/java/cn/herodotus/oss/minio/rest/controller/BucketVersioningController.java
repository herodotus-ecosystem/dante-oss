...
import cn.herodotus.oss.minio.logic.service.BucketVersioningService;
import cn.herodotus.oss.minio.rest.request.bucket.SetBucketVersioningRequest;
...
/**
 * <p>Description: Minio 存储桶版本管理接口 </p>
 *
 * @author : gengwei.zheng
 * @date : 2023/6/28 18:53
 */
@RestController
...
public class BucketVersioningController implements Controller {

    private final BucketVersioningService bucketVersioningService;

    public BucketVersioningController(BucketVersioningService bucketVersioningService) {
    ...
    public Result<Boolean> set(@Validated @RequestBody SetBucketVersioningRequest request) {
        bucketVersioningService.setBucketVersioning(request.build());
        return result(true);
    }
}
