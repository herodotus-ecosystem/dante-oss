...
import cn.herodotus.oss.minio.rest.request.bucket.DeleteBucketEncryptionRequest;
import cn.herodotus.oss.minio.rest.request.bucket.SetBucketEncryptionRequest;
...
public class BucketEncryptionController implements Controller {

    private final BucketEncryptionService bucketEncryptionService;

    public BucketEncryptionController(BucketEncryptionService bucketEncryptionService) {
    ...
    public Result<Boolean> set(@Validated @RequestBody SetBucketEncryptionRequest request) {
        bucketEncryptionService.setBucketEncryption(request.build());
        return result(true);
    }
    ...
    public Result<Boolean> delete(@Validated @RequestBody DeleteBucketEncryptionRequest request) {
        bucketEncryptionService.deleteBucketEncryption(request.build());
        return result(true);
    }
}
