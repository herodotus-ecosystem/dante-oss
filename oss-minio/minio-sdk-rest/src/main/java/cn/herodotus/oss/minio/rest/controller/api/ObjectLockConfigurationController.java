...
import cn.herodotus.oss.minio.rest.request.bucket.DeleteObjectLockConfigurationRequest;
import cn.herodotus.oss.minio.rest.request.bucket.SetObjectLockConfigurationRequest;
...
/**
 * <p>Description: Minio 存储桶对象锁定管理接口 </p>
 *
...
public class ObjectLockConfigurationController implements Controller {

    private final ObjectLockConfigurationService objectLockConfigurationService;

    public ObjectLockConfigurationController(ObjectLockConfigurationService objectLockConfigurationService) {
    ...
    public Result<Boolean> set(@Validated @RequestBody SetObjectLockConfigurationRequest request) {
        objectLockConfigurationService.setObjectLockConfiguration(request.build());
        return result(true);
    }
    ...
    public Result<Boolean> delete(@Validated @RequestBody DeleteObjectLockConfigurationRequest request) {
        objectLockConfigurationService.deleteObjectLockConfiguration(request.build());
        return result(true);
    }
}
