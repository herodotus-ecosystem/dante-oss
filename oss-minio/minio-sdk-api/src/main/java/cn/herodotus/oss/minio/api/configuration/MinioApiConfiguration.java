...
package cn.herodotus.oss.minio.api.configuration;

import cn.herodotus.oss.minio.api.definition.pool.MinioAsyncClientObjectPool;
...
/**
 * <p>Description: Minio API 模块配置 </p>
 *
...
public class MinioApiConfiguration {

    private static final Logger log = LoggerFactory.getLogger(MinioApiConfiguration.class);

    @PostConstruct
    public void postConstruct() {
        log.debug("[Herodotus] |- SDK [Minio API] Auto Configure.");
    }
    ...
    @ComponentScan(basePackages = {
            "cn.herodotus.oss.minio.api.service",
    })
