 ...
 */
public class MinioInsufficientDataException extends PlatformException {
    ...
    protected MinioInsufficientDataException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
