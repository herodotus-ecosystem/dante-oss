 ...
 */
public class MinioInvalidResponseException extends PlatformException {
    ...
    protected MinioInvalidResponseException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
