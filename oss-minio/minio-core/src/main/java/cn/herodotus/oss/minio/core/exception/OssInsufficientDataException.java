...
import cn.herodotus.oss.minio.core.constants.OssErrorCodes;
...
public class OssInsufficientDataException extends PlatformException {
    ...
    public Feedback getFeedback() {
        return FeedbackFactory.internalServerError(OssErrorCodes.OSS_INSUFFICIENT_DATA, "对象存储服务器返回数据不足");
    }
}
