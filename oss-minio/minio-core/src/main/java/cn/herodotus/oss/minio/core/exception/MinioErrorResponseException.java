 ...
 */
public class MinioErrorResponseException extends PlatformException {
    ...
    protected MinioErrorResponseException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
