 ...
 */
public class MinioXmlParserException extends PlatformException {
    ...
    protected MinioXmlParserException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
