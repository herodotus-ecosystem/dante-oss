 ...
 */
public class MinioIOException extends PlatformException {
    ...
    protected MinioIOException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
