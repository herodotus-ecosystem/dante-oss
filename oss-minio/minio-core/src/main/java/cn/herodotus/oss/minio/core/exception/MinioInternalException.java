 ...
 */
public class MinioInternalException extends PlatformException {
    ...
    protected MinioInternalException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
        super(message, cause, enableSuppression, writableStackTrace);
    }

    @Override
    public Feedback getFeedback() {
        return FeedbackFactory.internalServerError(MinioErrorCodes.OSS_INTERNAL, "对象存储服务器内部错误");
    }
}
