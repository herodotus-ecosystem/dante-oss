 ...
 */
public interface MinioErrorCodes extends ErrorCodes {

    int MINIO_CLIENT_POOL_ERROR = OSS_MODULE_500_BEGIN + 1;
    int MINIO_ERROR_RESPONSE = MINIO_CLIENT_POOL_ERROR + 1;
