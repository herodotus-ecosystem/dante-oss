...
public interface MinioConstants extends BaseConstants {
    ...
    String MINIO_MULTIPART_UPLOAD_REQUEST_MAPPING = "/oss/minio/multipart";
    ...
    String PRESIGNED_OBJECT_URL_PROXY = MINIO_MULTIPART_UPLOAD_REQUEST_MAPPING + MINIO_PRESIGNED_OBJECT_REQUEST_MAPPING;
